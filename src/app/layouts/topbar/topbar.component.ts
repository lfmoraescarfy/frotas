...
export class TopbarComponent implements OnInit {
  ...
  numeroSuporte: number = 4896805685; //Número do Nando ¯\_(ツ)_/¯  
  mensagemSuporte: string = encodeURIComponent("Olá, estou precisando de ajuda com...");
  ...
  */
  ...
  getPicture() {
    ...
    if(this.userData.foto)
      def = this.userData.foto;

    return def;
  }

  getPerfil(perfis: number[]) {
    return (perfis.length == 1) ? PerfilEnum[perfis[0]] : `${perfis.length} perfis`;
  }
}
