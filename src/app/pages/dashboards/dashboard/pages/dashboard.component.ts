...
import { BestSelling, Recentelling, TopSelling, statData } from 'src/app/core/data/dashboard';
...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (sessionStorage.getItem('toast')) {
      this.toastService.show('Login realizado com sucesso.', { classname: 'bg-success text-center text-white', delay: 5000 });
